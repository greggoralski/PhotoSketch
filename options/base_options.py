...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', required=True, default='/content/PhotoSketch/examples/', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
